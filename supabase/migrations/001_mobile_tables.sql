-- ============================================================
-- StrongNailBits B2B Mobile App — Database Migration
...
INSERT INTO app_config (key, value, description) VALUES
  ...
  ('email', '"info@strongnailbitsb2b.com"', 'Контактный email'),
  ('instagram', '"https://www.instagram.com/strongnailbits_b2b/"', 'Instagram'),
  ('telegram_channel', '"https://t.me/strongnailbits_b2b"', 'Telegram-канал'),
...
INSERT INTO pages (slug, title_uk, title_ru, content_uk, content_ru) VALUES
  ('about', 'Про нас', 'О нас',
   '# Про StrongNailBits B2B

StrongNailBits B2B — це оптова платформа професійної косметики. Ми працюємо з салонами краси, барбершопами, косметологічними кабінетами та іншими B2B-клієнтами.
...
- **Підтримка 24/7** — персональний менеджер для кожного клієнта',
   ...
   '# О StrongNailBits B2B

StrongNailBits B2B — это оптовая платформа профессиональной косметики. Мы работаем с салонами красоты, барбершопами, косметологическими кабинетами и другими B2B-клиентами.
...
- **Telegram**: @strongnailbits_b2b
- **Instagram**: @strongnailbits_b2b
...
Ваша конфіденційність важлива для нас. Ця політика описує, як StrongNailBits B2B збирає, використовує та захищає вашу персональну інформацію.
...
Ваша конфиденциальность важна для нас. Эта политика описывает, как StrongNailBits B2B собирает, использует и защищает вашу персональную информацию.
...
-- ============================================================
-- DONE! All tables created for StrongNailBits B2B Mobile App.
-- ============================================================
