...
export default function LinkPhonePage() {
  ...
  async function handleVerifyAndLink() {
    ...
    try {
      ...
      // 2. Link phone to Apple account (or merge with existing phone account)
      ...
      // If account was merged, we need to re-login as the merged user
      ...
      <div className="w-full">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-[var(--t2)]">
            Для завершення входу через Apple, вкажіть ваш номер телефону
          </p>
        </div>
