...
const BRAND_FIELDS = 'id, cs_cart_id, name, slug, logo_url, banner_url, description_uk, description_ru, country, website_url, is_featured, position, status, meta_title, meta_description, photo_source_url, info_source_url, parse_config, source_urls, source_notes, ai_prompt_context, created_at, updated_at';
  ...
  try {
    ...
    const { data, error } = await supabase
      ...
      .insert({
        ...
        ai_prompt_context: body.ai_prompt_context || '',
      })
      .select(BRAND_FIELDS)
      .single();
...
export async function PUT(request: NextRequest) {
  try {
    ...
    const allowed = ['name', 'slug', 'description_uk', 'description_ru', 'logo_url', 'banner_url', 'country', 'website_url', 'is_featured', 'position', 'status', 'meta_title', 'meta_description', 'photo_source_url', 'info_source_url', 'parse_config', 'source_urls', 'source_notes', 'ai_prompt_context'];
