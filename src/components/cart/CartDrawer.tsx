...
export function CartDrawer({ open, onClose }: CartDrawerProps) {
  ...
  // Two-phase animation: mount → visible → hidden → unmount
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-y-0 right-0 z-[70] flex w-full max-w-md flex-col border-l border-[var(--border)] bg-pearl transition-transform duration-300 ease-out ${
