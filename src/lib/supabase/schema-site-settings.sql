...
('social', '{"instagram":{"url":"https://www.instagram.com/strongnailbits.com.ua/","label":"Instagram"},"telegram":{"url":"https://t.me/strongnailbits_ua","label":"Telegram"},"facebook":{"url":"https://www.facebook.com/strongnailbits.com.ua/","label":"Facebook"},"tiktok":{"url":"","label":"TikTok"},"youtube":{"url":"","label":"YouTube"}}'::jsonb),
...
('seo', '{"title_default":"STRONG NAIL BITS — Професійна nail-косметика","title_template":"%s | STRONG NAIL BITS","description":"Професійна косметика для nail-майстрів. Гель-лаки, бази, топи, інструменти. Оптові ціни від 1-ої одиниці. Доставка по Україні.","keywords":["гель-лак оптом","nail косметика","B2B краса","Strong Nail Bits","манікюр"],"og_image":"","theme_color":"#f5f5f7"}'::jsonb),
